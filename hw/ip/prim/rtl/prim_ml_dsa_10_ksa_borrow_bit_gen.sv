...
module prim_ml_dsa_10_ksa_borrow_bit_gen #(
  parameter int unsigned ShareWidth = 24,
  parameter int unsigned RandWidth = 256,
  ...
  for (genvar ii = 0; ii < (ShareWidth - 1); ii=ii+2) begin : gen_refresh_even_input
    assign a0[ii] = x0_i[ii] ^ r_i[r_index++];
    assign a1[ii] = x1_i[ii] ^ r_i[r_index++];
  end
  ...
  for (genvar ii = 1; ii < ShareWidth; ii=ii+2) begin : gen_ks_stage_1
    ...
    prim_ml_dsa_dom_and u_prim_ml_dsa_dom_and (
      .clk_i,
      .rst_ni,
      .a0_i(a0_xor_u[ii]),
      .a1_i(a1[ii]),
    ...
    prim_ml_dsa_dom_and_xor_refresh u_prim_ml_dsa_dom_and_xor_refresh (
      .clk_i,
      .rst_ni,
      .a0_i(a0[ii]),
      .a1_i(a1[ii]),
