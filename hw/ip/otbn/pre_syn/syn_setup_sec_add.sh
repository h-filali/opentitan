...
case "$TARGET_TYPE" in
  test)        export LR_SYNTH_TOP_MODULE=otbn_sec_add_sca_test_wrapper ;;
  ...
  mask_acc_prolead)  export LR_SYNTH_TOP_MODULE=otbn_mask_accelerator ;;
...
export LR_SYNTH_CELL_LIBRARY_PATH=/home/hakim/OpenROAD-flow-scripts/flow/platforms/nangate45/lib/NangateOpenCellLibrary_typical.lib
