      ...
      "err_code": begin
        if (data_phase_read) begin
          ...
          if (err_code.code == ErrSwCmdSequence) begin
            ...
            do_read_check = 0;
            `DV_CHECK_NE(err_code.info[6:3], prim_mubi_pkg::MuBi4False, $sformatf("reg name: %0s", csr.get_full_name()))
            `DV_CHECK_NE(err_code.info[6:3], prim_mubi_pkg::MuBi4True, $sformatf("reg name: %0s", csr.get_full_name()))
          end
        end
      end
